Feature: Calculator full result for healthy Female
    This test assert health person COVID AGE result
@Test_Full_Biometric
Scenario: Healthy female result
  ...
  When I enter the weight "145"
  When I enter Circ. "29"
  ...
  Then I check outpot Blood Pressure "- 00y 03m 04d"
  ...
  And I see Calculated age month "08m"
