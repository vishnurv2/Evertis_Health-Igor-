Feature: Calculator full result for average Female
    This test assert health person COVID AGE result
@Test_Full_Biometric1
@weekly_regression
Scenario: average female result
  ...
  Then I check outpot Blood Pressure "+ 03y 05m 16d"
  When I enter Vitamin D Level "32"
  And I see Vitamin D Level output "+ 00y 01m 12d"
  When I enter FMD "10"
  ...
  And I see Hospitality value equal "5.33"
  And I see ICU Admision value equal "1.7"
  And I see Mortality value equal "0.25"
  And I see Calculated age years "55y"
  And I see Calculated age month "06m"
  And I see Calculated age days "03d"
  And I close all
